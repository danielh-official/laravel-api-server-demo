...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="POSTapi-partners"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="website"                data-endpoint="POSTapi-partners"
               value="d"
               data-component="body">
    <br>
<p>Must be a valid URL. Must not be greater than 255 characters. Example: <code>d</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string[]</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="specialties[0]"                data-endpoint="POSTapi-partners"
               data-component="body">
        <input type="text" style="display: none"
               name="specialties[1]"                data-endpoint="POSTapi-partners"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="description"                data-endpoint="PUTapi-partners--id-"
               value="Et animi quos velit et fugiat."
               data-component="body">
    <br>
<p>Must not be greater than 5000 characters. Example: <code>Et animi quos velit et fugiat.</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="website"                data-endpoint="PUTapi-partners--id-"
               value="d"
               data-component="body">
    <br>
<p>Must be a valid URL. Must not be greater than 255 characters. Example: <code>d</code></p>
...
<small>string[]</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="specialties[0]"                data-endpoint="PUTapi-partners--id-"
               data-component="body">
        <input type="text" style="display: none"
               name="specialties[1]"                data-endpoint="PUTapi-partners--id-"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters.</p>
        </div>
